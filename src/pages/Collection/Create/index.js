              ...
              try {
                ...
                try {
                  ...
                  signature = await signer.signMessage(
                    `Approve Signature on nftzip.io with nonce ${nonce}`
                  );
                } catch (err) {
                  toast(
                    'error',
      ...
      <div className={styles.inner}>
        ...
        {isRegister && (
          <div className={styles.inputGroup}>
            <div className={styles.inputTitle}>
              Royalty *&nbsp;
              <BootstrapTooltip
                title="Each NFT under this collection exchanged through nftzip will have a percentage of sale given to nominated wallet address."
                placement="top"
              >
                <HelpOutlineIcon />
              </BootstrapTooltip>
        ...
        <div className={styles.inputGroup}>
          ...
          <div className={styles.inputSubTitle}>
            ...
            <a
              href="https://docs.fantom.foundation/tutorials/collection-and-bundle-guide-on-nftzip"
              target="_blank"
