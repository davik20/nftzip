...
const cards = [
  ...
  },
  {
    ...
    title: 'Super Fast',
    description:
      'Since nftzip runs on the Fantom Opera Network, transactions are usually confirmed within 1-2 seconds.',
    path: '/',
  },
  {
    icon: card3,
  ...
  },
  {
    ...
    description:
      'Trade NFTs via auction or direct offer without any fees taken by nftzip.',
    path: '/explore',
  },
];
    ...
    <div className={styles.container}>
        ...
        <div className={styles.main}>
          <div className={styles.mainLeft}>
            <div
              ...
              style={{ color: '#FFF' }}
            >{`Trade without platform fees on nftzip`}</div>
            <div className={styles.subtitle}>
              nftzip is an NFT marketplace built on Fantom. Create and trade
          ...
          <div className={styles.card}>
            <div className={styles.cardMedia}>
              <ReactPlayer
                ...
                url={`https://nftzip.mypinata.cloud/ipfs/QmNjxsiHzRVhbL1WYhxXhJsHCRgCA2bx6LtUJHVmAd3Kir`}
                controls={true}
              />
            </div>
            <div
      ...
      <div className={styles.about}>
        <div className={styles.aboutInner}>
          <div className={styles.aboutTitle}>Why nftzip</div>
